...
class FoodInformationActivity :
    BaseActivity<ActivityFoodInformationBinding, FoodInformationViewModel>() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val indicator: CircleIndicator3 =
            findViewById<CircleIndicator3>(R.id.CircleIndicator3_Image_Food)
